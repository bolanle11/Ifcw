...
class IFCWSite extends TimberSite {
	...
	function __construct() {
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'ifcw' ),
			'quick-links'  => __( 'Quick Links Menu', 'ifcw' ),
		) );
	...
	public function widgets_init()
	{
		if (function_exists('register_sidebar')) {
			...
			register_sidebar(array(
				...
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget__title widget__title--sidebar">',
				'after_title'   => '</h2>'
			));
	...
	function add_to_context( $context ) {
		...
		$context['main_footer'] = Timber::get_widgets('main-footer');
